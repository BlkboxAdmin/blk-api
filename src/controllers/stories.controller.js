...
const getBlkBoardStories = async (req, res) => {
    try {
        const page = req.params.page ?? 1;
        const model = new Stories();
        const response = await model.boardByUserId(page, req.body);
...
const repost = async (req, res) => {
    ...
    try {
        ...
        const aParams = {
            type: 'NEW_STORY_REPOST_ACTIVITY',
            data: response.data,
            user_id: userId,
            created_by: userId
        };
